...
- 示例：[底部出现数个像素的锯齿状画面残留](../assets/historical-error-examples/05-02-底部像素残留.jpg)
...
- 示例：[材质文案使用“其他”概括成分](../assets/historical-error-examples/16-03-材质简略表述.jpg)
- 对照：[具体面料成分与比例完整列示](../assets/historical-error-examples/16-04-材质完整表述.jpg)
- 比对具体面料成分信息、详情页、水洗唛、合格证和吊牌中的成分名称、比例、部位及“涂层除外”等限定文字。权威依据列出具体纤维时，“其他”不能替代明细。
...
- 示例：[人物介绍文案包含“权威”](../assets/historical-error-examples/18-平台驳回词权威.jpg)
- 运行驳回词扫描后结合完整语境、适用平台和类目复核；平台或类目未知时保留命中项并标记待补证。
